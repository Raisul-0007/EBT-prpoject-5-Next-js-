     ...
     <Container>
      ...
      <div className="flex py-20">
        <div className="w-1/3 flex">
            <div className=" w-15 h-15 py-1.5 px-1.5 mx-5 border-2 border-transparent [border-image:linear-gradient(to_right,#e03609,#f0b71f)_1]">
...
<stop offset="1" stopColor="#E03609"/>
            ...
            <div className="px-2">
                <h5 className='font-montserrat text-3xl text-white'>Discover the Future</h5>
                <p className='px-2 font-montserrat text-md py-6 text-[#DDDD]'>Explore the high-tech, low-life world where the lines between humanity </p>
            </div>
        </div>
        <div className="w-1/3 flex">
            <div className="w-15 h-15 py-1 px-1.5 mx-5 border-2 border-transparent [border-image:linear-gradient(to_right,#e03609,#f0b71f)_1]"> <svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<stop offset="1" stopColor="#E03609"/>
            ...
            <div className="px-6">
                <h5 className='font-montserrat text-3xl text-white'>Explore Features</h5>
        ...
        <div className="w-1/3 flex">
            <div className="w-15 h-15 py-2.5 px-3 mx-5 border-2 border-transparent [border-image:linear-gradient(to_right,#e03609,#f0b71f)_1]">
...
<stop offset="1" stopColor="#E03609"/>
            ...
            <div className="px-6">
                <h5 className='font-montserrat text-3xl text-white'>Stay Connected</h5>
            <p className='font-montserrat text-md py-6 text-[#DDDD]'>Explore the high-tech, low-life world where the lines between humanity </p>
            </div>
