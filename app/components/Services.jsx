     ...
     <Container>
      ...
      <div className="flex py-20">
        <div className="w-1/3 flex">
            <div className=" w-18 h-18 py-3 px-3 mx-5 border-2 border-transparent [border-image:linear-gradient(to_right,#e03609,#f0b71f)_1]">
...
<stop offset="1" stopColor="#E03609"/>
        ...
        <div className="w-1/3 flex">
            <div className="w-18 h-18 py-2 px-3 mx-5 border-2 border-transparent [border-image:linear-gradient(to_right,#e03609,#f0b71f)_1]"> <svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<stop offset="1" stopColor="#E03609"/>
        ...
        <div className="w-1/3 flex">
            <div className="w-20 h-18 py-4 px-4 mx-5 border-2 border-transparent [border-image:linear-gradient(to_right,#e03609,#f0b71f)_1]">
